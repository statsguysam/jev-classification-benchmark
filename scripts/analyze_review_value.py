...
def findings(report):
    ...
    lines = ["# Added value of Jev review: offline numeric evidence", "",
        f"**{report['complete_review_conditions']}/24 complete numeric review conditions are scored.** No partial-run accuracy is used. Breast Cancer has 114 test cases, Wine 36, each on one frozen split. This report covers numerical reviews; the text extension is reported separately.", "",
