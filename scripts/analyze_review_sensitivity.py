...
def findings(report):
    ...
    lines += ["", "## What survives the broader scope", "",
        f"Across the five added constant-label conditions, {patterns['above_at_all_intermediate_rates']} has accuracy above the random-selection expectation at all four intermediate coverages, {patterns['below_at_all_intermediate_rates']} are below it throughout, {patterns['mixed']} has mixed differences, and {patterns['ties_at_all_intermediate_rates']} ties throughout. These are descriptive signs of differences, not statistical tests; all five conditions and all six coverages are displayed above.", "",
